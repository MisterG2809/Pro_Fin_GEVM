...
<footer class="footer-tech">
    <div class="container">
        ...
        <p class="copyright">&copy; 2026 OBLIVION · desarrollado por <strong style="color:var(--primary);">MaverickTec</strong> · <a href="privacidad.jsp" style="color:var(--text-muted);text-decoration:none;font-size:0.75rem;">Aviso de Privacidad</a></p>
    </div>
</footer>
